...
import { DeleteMaterialDialog } from "@/widgets/DeleteMaterialDialog";
...
export default function UiDesignUiKitAndMoodboard() {
  ...
  return (
    <main className="flex flex-col xl:mt-[92px] mt-[64px]">
      ...
      <article className="mt-12 flex flex-col gap-12 font-extralight xl:text-2xl text-lg">
        ...
        <section className="flex flex-col gap-12 xl:[&>*:not(header)]:px-16 [&>*:not(header)]:px-3">
          <header className="xl:pt-16 xl:pl-32 xl:pb-32 pl-3 py-12 flex flex-col xl:gap-5 gap-4 w-full relative overflow-hidden">
            ...
            />
            <div className="absolute xl:h-[500px] xl:w-[1000px] h-[200px] w-[400px] bg-radial from-[#F25AB4] to-[#F25AB400] -z-10 xl:-top-52 -top-20 xl:-right-72 -right-44 rounded-full blur-3xl" />
            <div className="absolute xl:h-[500px] xl:w-[1000px] h-[200px] w-[400px] bg-radial from-[#944BEC] to-[#944BEC00] -z-10 xl:-bottom-96 -bottom-24 xl:-right-24 -right-32 rounded-full blur-3xl" />
          </header>
          <ArticleListBlock
        ...
        <section className="xl:px-16 px-3 flex flex-col xl:gap-6 gap-4">
          <h2 className="font-defectica font-normal xl:text-4xl text-3xl">
            Заключение
          </h2>
