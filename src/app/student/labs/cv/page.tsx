    ...
    <main className="flex flex-col xl:px-16 px-3 xl:mt-[92px] mt-16">
      ...
      <article className="xl:mt-16 mt-8 flex flex-col gap-12">
        <section className="flex flex-col gap-6">
          <h1 className="text-6xl font-defectica leading-10 h-10">CV</h1>
          <h2 className="text-4xl font-defectica leading-7 h-7">
            Лабораторная работа
          </h2>
        ...
        <section className="flex flex-col gap-6">
          <h3 className="text-3xl">Оценивание</h3>
        ...
        <section className="flex flex-col gap-6">
            <h2 className="font-defectica text-4xl">Ваш ответ</h2>
            <div className="flex xl:gap-5 gap-2 xl:flex-row flex-col">
              <Input className="bg-almost-black max-w-2xl" placeholder="Вставьте ссылку сюда"/>
